...
The application user face for the Route-88 application.
...
To run the desired flavor either use the launch configuration in VSCode/Android Studio or use the following commands (run these inside the `route_88` directory):
...
_\*Route 88 works on iOS, Android, Web, and Windows._

---

## Running Tests 🧪

To run all unit and widget tests use the following command (run this inside the `route_88` directory):
...
[coverage_badge]: route_88/coverage_badge.svg
